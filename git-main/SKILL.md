---
name: git-main
description: Safely switch back to the repo's default branch (main or master, auto-detected from the origin remote) and pull the latest changes, warning first if there are uncommitted changes. Use whenever the user says "go to main", "switch to main/master", "get back on main", "sync main", or wants to return to and update the default branch.
---
